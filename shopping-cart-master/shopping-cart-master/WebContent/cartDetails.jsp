...
<body style="background-color: #E6F9E6;">
	...
	<div class="text-center"
		style="color: rgb(128, 83, 0); font-size: 24px; font-weight: bold;">Cart
		Items</div>
 ...
 -->
	...
	<div class="container">
		...
		<table class="table table-hover">
			<thead
				style="background-color: #6ab6df; color: white; font-size: 16px; font-weight: bold;">
				<tr>
					<th>Picture</th>
					<th>Products</th>
					<th>Price</th>
			...
			<tbody
				...
				<tr style="background-color: grey; color: white;">
					...
					<td colspan="2" align="center"><form method="post">
							<button style="background-color: rgb(142, 142, 240); color: white;"
